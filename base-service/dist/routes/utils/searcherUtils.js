...
exports.handlelogic = exports.fillValues = void 0;
...
var _require = require("./directMapping"),
  directMapping = _require.directMapping;
var _require2 = require("./externalAPIMapping"),
  externalAPIMapping = _require2.externalAPIMapping;
var _require3 = require("./commons"),
  getValue = _require3.getValue,
  getDateInRequiredFormat = _require3.getDateInRequiredFormat;
...
var updateBorderlayout = function updateBorderlayout(formatconfig) {
  formatconfig.content = formatconfig.content.map(function (item) {
    if (item.hasOwnProperty("layout") && _typeof(item.layout) === "object" && Object.keys(item.layout).length === 0) {
 ...
 */
var fillValues = function fillValues(variableTovalueMap, formatconfig) {
...
var generateQRCodes = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(moduleObject, dataconfig, variableTovalueMap) {
  ...
  return function generateQRCodes(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
var handleDerivedMapping = function handleDerivedMapping(dataconfig, variableTovalueMap) {
  var derivedMappings = getValue(jp.query(dataconfig, "$.DataConfigs.mappings.*.mappings.*.derived.*"), [], "$.DataConfigs.mappings.*.mappings.*.derived.*");
  for (var i = 0, len = derivedMappings.length; i < len; i++) {
    ...
    var variableValue = Function("'use strict'; return (".concat(expression, ")"))();
    if (type == "date") {
      var myDate = new Date(variableValue);
      if (isNaN(myDate) || variableValue === 0) {
        variableValue = "NA";
      } else {
        var replaceValue = getDateInRequiredFormat(variableValue, format);
...
var handlelogic = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(key, formatObject, moduleObject, dataconfig, isCommonTableBorderRequired, requestInfo) {
    var variableTovalueMap;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          variableTovalueMap = {}; //direct mapping service
          _context2.next = 3;
          return Promise.all([directMapping(moduleObject, dataconfig, variableTovalueMap, requestInfo, unregisteredLocalisationCodes, key),
          //external API mapping
          externalAPIMapping(key, moduleObject, dataconfig, variableTovalueMap, requestInfo, unregisteredLocalisationCodes)]);
        case 3:
          ...
          return _context2.abrupt("return", formatObject);
        case 8:
        case "end":
  ...
  return function handlelogic(_x4, _x5, _x6, _x7, _x8, _x9) {
    return _ref2.apply(this, arguments);
  };
}();
exports.handlelogic = handlelogic;