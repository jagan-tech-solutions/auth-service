...
var envVariables = {
  ...
  EGOV_LOCALISATION_HOST: process.env.EGOV_LOCALISATION_HOST || _config["default"].host.serverHost,
  EGOV_LOCALISATION_SEARCH: process.env.EGOV_LOCALISATION_SEARCH || "localization/messages/v1/_search",
  EGOV_FILESTORE_SERVICE_HOST: process.env.EGOV_FILESTORE_SERVICE_HOST || _config["default"].host.serverHost,
  ...
  KAFKA_TOPICS_NOTIFICATION: process.env.KAFKA_TOPICS_NOTIFICATION || "egov.core.notification.sms",
  ...
  EGOV_EXTERNAL_HOST: process.env.EGOV_EXTERNAL_HOST || _config["default"].host.serverHost,
  ...
  DATA_CONFIG_URLS: _config["default"].configs.DATA_CONFIG_URLS,
  FORMAT_CONFIG_URLS: _config["default"].configs.FORMAT_CONFIG_URLS
};
