...
var BRANCH = "master";
var _require = require("../middlewares/asyncMiddleware"),
...
router.post("/v1/_search", asyncMiddleware( /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var _req$body;
    var MdmsCriteria, tenantId, moduleDetails, _ref3, moduleName, masterDetails, _ref4, name, mdmsResponse, response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          // var module = req.query.module;
          // var master = req.query.master;
          MdmsCriteria = req === null || req === void 0 ? void 0 : (_req$body = req.body) === null || _req$body === void 0 ? void 0 : _req$body.MdmsCriteria;
          tenantId = MdmsCriteria.tenantId, moduleDetails = MdmsCriteria.moduleDetails;
          _ref3 = (moduleDetails === null || moduleDetails === void 0 ? void 0 : moduleDetails[0]) || {}, moduleName = _ref3.moduleName, masterDetails = _ref3.masterDetails;
          _ref4 = (masterDetails === null || masterDetails === void 0 ? void 0 : masterDetails[0]) || {}, name = _ref4.name; // const names = await httpRequest('https://raw.githubusercontent.com/jeanphorn/wordlist/master/usernames.txt',{},{});
          _context2.next = 6;
