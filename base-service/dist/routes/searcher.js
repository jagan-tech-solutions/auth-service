...
var _searcherUtils = require("./utils/searcherUtils");
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          i = 0;
          dataConfigUrls && dataConfigUrls.split && dataConfigUrls.split(",").map(function (item) {
            item = item.trim();
...
initialise();
var prepareBulk = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(key, dataconfig,
  // formatconfig,
  req, baseKeyPath, requestInfo, returnFileInResponse, entityIdPath) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          console.log('peee');
          isCommonTableBorderRequired = (0, _lodash["default"])(dataconfig, "DataConfigs.isCommonTableBorderRequired");
        ...
        case 11:
          ...
          formatObject = {};
          _context3.next = 18;
          return (0, _searcherUtils.handlelogic)(key, formatObject, moduleObject, dataconfig, isCommonTableBorderRequired, requestInfo);
        case 18:
          formatObject = _context3.sent;
          ...
          if (!returnFileInResponse && countOfObjectsInCurrentFile == maxPagesAllowed || i + 1 == len) {
            ...
            if (!locale) locale = envVariables.DEFAULT_LOCALISATION_LOCALE;
            if (defaultFontMapping[locale] != 'default') formatconfigCopy.defaultStyle.font = defaultFontMapping[locale];
        ...
        case 23:
          ...
          break;
        case 26:
          return _context3.abrupt("return", [formatConfigByFile, totalobjectcount, entityIds]);
        case 29:
          logger.error("could not find property of type array in request body with name ".concat(baseKeyPath));
          throw {
            message: "could not find property of type array in request body with name ".concat(baseKeyPath)
          };
        case 31:
        case "end":
  ...
  return function prepareBulk(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref3.apply(this, arguments);
  };
}();
router.post("/getMusterDetails", asyncMiddleware( /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
    var tenantId, musterRollNumber, requestinfo, resProperty, key, dataconfig, baseKeyPath, entityIdPath;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          tenantId = req.query.tenantId;
          musterRollNumber = req.query.musterRollNumber;
          ...
          if (!tenantId || !musterRollNumber) {
            throwError("tenantId and musterRollNumber are mandatory to get the muster details", "MISSING_MANDATORY_DETAILS", 400);
          }
          _context4.prev = 5;
          key = req.query.key || "consolidatedreceipt";
          dataconfig = dataConfigMap[key];
          baseKeyPath = (0, _lodash["default"])(dataconfig, "DataConfigs.baseKeyPath");
          entityIdPath = (0, _lodash["default"])(dataconfig, "DataConfigs.entityIdPath");
          if (!(baseKeyPath == null)) {
            _context4.next = 13;
            break;
          }
        ...
        case 13:
          _context4.next = 15;
          return prepareBulk(key, dataconfig, req, baseKeyPath, req.body.RequestInfo, true, entityIdPath);
        case 15:
          return _context4.abrupt("return", _context4.sent);
        case 19:
          _context4.prev = 19;
          _context4.t0 = _context4["catch"](5);
          throwError(_context4.t0.message, _context4.t0.code, _context4.t0.status);
        case 22:
        case "end":
